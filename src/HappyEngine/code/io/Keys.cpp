...
int getWebKeyFromKey(Key key)
{
    switch (key)
    {
        ...
        mapWebKey(Tab, TAB)
        mapWebKey(KP_0, NUMPAD0)
        mapWebKey(KP_1, NUMPAD1)
        mapWebKey(KP_2, NUMPAD2)
        mapWebKey(KP_3, NUMPAD3)
        mapWebKey(KP_4, NUMPAD4)
        mapWebKey(KP_5, NUMPAD5)
        mapWebKey(KP_6, NUMPAD6)
        mapWebKey(KP_7, NUMPAD7)
        mapWebKey(KP_8, NUMPAD8)
        mapWebKey(KP_9, NUMPAD9)
