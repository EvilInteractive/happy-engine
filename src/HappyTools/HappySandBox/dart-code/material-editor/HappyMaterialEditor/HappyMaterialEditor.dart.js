...
$$.Connecter = {"":
 ["m_Name", "m_Index", "m_Parent", "m_IsInput"],
 "super": "Object",
 draw$1: function(context) {
  var t1 = this.m_Parent;
  var x = t1.GetXPosConnecter$1(this);
  var y = t1.GetYPosConnecter$1(this);
  context.setShadow$5(0, 0, 0, 0, 0);
  context.setFillColor$4(0.1, 0.1, 0.1, 1);
  context.fillRect$4(x, y, 4, 4);
  t1 = this.m_IsInput === false;
  var t2 = this.m_Name;
  if (t1) {
    context.set$textAlign('left');
    context.fillText$3(t2, $.add($.add(x, 4), 4), y);
  } else {
    context.set$textAlign('right');
    context.fillText$3(t2, $.sub(x, 4), y);
  }
}
};

$$.Node = {"":
 ["m_X", "m_Y", "inputs", "outputs"],
 "super": "Object",
 addInput$1: function(input) {
  this.inputs.push(input);
},
 addOutput$1: function(output) {
  this.outputs.push(output);
},
 GetXPosConnecter$1: function(c) {
  var t1 = c.m_IsInput === true;
  var t2 = this.m_X;
  if (t1)
    return t2 + 128;
  else
 ...
 GetYPosConnecter$1: function(c) {
  var t1 = this.inputs.length + 1;
  if (typeof t1 !== 'number')
    throw $.iae(t1);
  var yInputOffset = 80 / t1;
  t1 = this.m_Y + 8;
  var t2 = c.m_Index + 1;
  if (typeof t2 !== 'number')
    throw $.iae(t2);
  return t1 + yInputOffset * t2;
},
 draw$1: function(context) {
  context.setShadow$5(4, 4, 2, 0, 1);
  context.setFillColor$4(0.5, 0.1, 1, 1);
  context.fillRect$4(this.m_X, this.m_Y, 128, 96);
  $.forEach(this.inputs, new $.Node_draw_anon(context));
  $.forEach(this.outputs, new $.Node_draw_anon0(context));
}
};
...
$$.Node_draw_anon = {"":
 ...
 "super": "Closure",
 call$1: function(c) {
  return c.draw$1(this.context_0);
}
};
...
$$.Node_draw_anon0 = {"":
 ...
 "super": "Closure",
 call$1: function(c) {
  return c.draw$1(this.context_1);
}
};
...
$.tick = function(time) {
  $.forEach($.c.get$m_NodeList(), new $.tick_anon());
  $.window().requestAnimationFrame$1($.tick);
};
...
$.NodeContainer$ = function() {
  return new $.NodeContainer($.ListImplementation_List(null));
};
...
$.main = function() {
  ...
  $.c = $.NodeContainer$();
  var node1 = $.Node$(5, 5);
  var i1 = $.Connecter$(node1, 0, 'TestInput', true);
  var o1 = $.Connecter$(node1, 0, 'TestOut', false);
  node1.addInput$1(i1);
  node1.addOutput$1(o1);
  var node2 = $.Node$(5, 5);
  var i2 = $.Connecter$(node2, 0, 'i1', true);
  var i3 = $.Connecter$(node2, 1, 'i2', true);
  var i4 = $.Connecter$(node2, 2, 'i3', true);
  var o2 = $.Connecter$(node2, 0, 'o1', false);
  node2.addInput$1(i2);
  node2.addInput$1(i3);
  node2.addInput$1(i4);
  node2.addOutput$1(o2);
  $.add$1($.c.get$m_NodeList(), node1);
  $.add$1($.c.get$m_NodeList(), node2);
  $.window().requestAnimationFrame$1($.tick);
};
...
$.Node$ = function(m_X, m_Y) {
  return new $.Node(m_X, m_Y, $.ListImplementation_List(null), $.ListImplementation_List(null));
};
...
$.Connecter$ = function(m_Parent, m_Index, m_Name, m_IsInput) {
  return new $.Connecter(m_Name, m_Index, m_Parent, m_IsInput);
};
...
$.$defineNativeClass('CanvasRenderingContext2D', ["textAlign!"], {
 ...
 setShadow$8: function(width, height, blur, c_OR_color_OR_grayLevel_OR_r, alpha_OR_g_OR_m, b_OR_y, a_OR_k, a) {
  return this.setShadow(width,height,blur,c_OR_color_OR_grayLevel_OR_r,alpha_OR_g_OR_m,b_OR_y,a_OR_k,a);
},
 setShadow$5: function(width,height,blur$,c_OR_color_OR_grayLevel_OR_r,alpha_OR_g_OR_m) {
  return this.setShadow(width,height,blur$,c_OR_color_OR_grayLevel_OR_r,alpha_OR_g_OR_m);
}
});
...
//@ sourceMappingURL=HappyMaterialEditor.dart.js.map