 ...
 if(CMAKE_BUILD_TOOL MATCHES "(msdev|devenv)") 
    ...
    # Release specific
    set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -Ot -GS- -D_HAS_ITERATOR_DEBUGGING=0 -D_SECURE_SCL=0 -GR- -Zm200")
    
    # Min Size Release specific
    set(CMAKE_CXX_FLAGS_MINSIZEREL "${CMAKE_CXX_FLAGS_MINSIZEREL} -D_HAS_ITERATOR_DEBUGGING=0 -D_SECURE_SCL=0 -GR- -Zm200")
    
    # Rel With Deb Info specific
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} -GR -Zm200")
    
    # Debug specific
    set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -WX -GR -Zm200")
