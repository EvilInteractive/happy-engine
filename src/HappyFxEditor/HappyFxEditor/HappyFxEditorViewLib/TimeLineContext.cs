...
namespace HappyFxEditorContextLib
{
    public class TimeLineContext : UndoableChangeSource
    {
        ...
        public TimeLineContext(EffectContext effect)
        {
            ...
            {
                new ComponentContext(TimeLineTrackComponentType.MAX_TYPES) { Width=128, Height=32 },  // Select tool
                new ComponentContext(TimeLineTrackComponentType.CameraFx) { Width=128, Height=32 },               
                new ComponentContext(TimeLineTrackComponentType.ParticleSystem) { Width=128, Height=32 },               
                new ComponentContext(TimeLineTrackComponentType.AudioFx) { Width=128, Height=32 }
            };
        }
